                        ...
                        <form action="logincode.php" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <br>
                                    <input type="radio" name="trip" value="4:30PM-5:00PM" required>4:30PM-5:00PM
                                    <br>
                            ...
                            <div class="mb-3">
                               <button type="submit" name="save_passenger" class="btn btn-primary float-end">SAVE</button>
                            </div>
